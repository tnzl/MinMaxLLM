...
int main(int argc, char** argv) {
    ...
    // Print statements 
            ...
            for (int i = 0; i < std::min(10, N*K); ++i) std::cout << input[i] << " ";
            std::cout << "\n";
            std::cout << "Input (last 10 elements): ";
            for (int i = std::max(0, N*K-10); i < N*K; ++i) std::cout << input[i] << " ";
            std::cout << "\n";
            
            std::cout << "\nWeight (first 10 elements): ";  
            for (int i = 0; i < std::min(10, K*M); ++i) std::cout << weight[i] << " ";
            std::cout << "\n";
            std::cout << "Weight (last 10 elements): ";
            for (int i = std::max(0, K*M-10); i < K*M; ++i) std::cout << weight[i] << " ";
            std::cout << "\n";
    ...
    for (int i = 0; i < std::min(10, N*M); ++i) std::cout << output[i] << " ";
    std::cout << "\n";
    std::cout << "Output (last 10 elements): ";
    for (int i = std::max(0, N*M-10); i < N*M; ++i) std::cout << output[i] << " ";
    std::cout << "\n";
